...
/**
  ...
  * @see Believe\Services\TeamsService::create()
  * @phpstan-import-type AnnualBudgetGbpVariants from \Believe\Teams\TeamCreateParams\AnnualBudgetGbp
  ...
  * @phpstan-type TeamCreateParamsShape = array{
  *   cultureScore: int,
  *   foundedYear: int,
  ...
  *
 */
final class TeamCreateParams implements BaseModel
{
  /** @use SdkModel<TeamCreateParamsShape> */
  use SdkModel;
  use SdkParams;
 ...
 */
  ...
  /**
  * `new TeamCreateParams()` is missing required properties by the API.
  *
  * To enforce required parameters use
  * ```
  * TeamCreateParams::with(
  *   cultureScore: ...,
  *   foundedYear: ...,
  *   league: ...,
  *   name: ...,
