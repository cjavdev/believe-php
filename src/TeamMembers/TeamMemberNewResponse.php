...
/**
  ...
  * @phpstan-type TeamMemberNewResponseVariants = Player|Coach|MedicalStaff|EquipmentManager
  *
  * @phpstan-type TeamMemberNewResponseShape = TeamMemberNewResponseVariants|PlayerShape|CoachShape|MedicalStaffShape|EquipmentManagerShape
  *
 */
final class TeamMemberNewResponse implements ConverterSource
{
  use SdkUnion;
