...
use Believe\TeamMembers\Player\MemberType;

/**
 * Full player model with ID.
 *
 * @phpstan-type PlayerShape = array{
 *   id: string,
 *   characterID: string,
 *   jerseyNumber: int,
 ...
 * }
 */
final class Player implements BaseModel
{
    /** @use SdkModel<PlayerShape> */
    use SdkModel;
    ...
    /**
     * `new Player()` is missing required properties by the API.
     *
