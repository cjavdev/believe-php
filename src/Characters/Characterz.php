 ...
 *
 * @phpstan-type CharacterzShape = array{
 *   id: string,
 *   background: string,
 ...
 * }
 */
final class Characterz implements BaseModel
{
    /** @use SdkModel<CharacterzShape> */
    use SdkModel;
    ...
    /**
     * `new Characterz()` is missing required properties by the API.
     *
