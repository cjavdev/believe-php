...
/**
  ...
  * @phpstan-type CharacterShape = array{
  *   id: string,
  *   background: string,
  ...
  *   salaryGbp?: string|null,
  *   signatureQuotes?: list<string>|null,
  *   teamID?: string|null,
  * }
  *
 */
final class Character implements BaseModel
{
  /** @use SdkModel<CharacterShape> */
  use SdkModel;
 ...
 */
  ...
  *
  * @var EmotionalStats $emotionalStats
 */
 ...
 */
  ...
  /**
  * `new Character()` is missing required properties by the API.
  *
 ...
 */
  ...
  * @return self
 */
  public function withSalaryGbp(?string $salaryGbp): self {
    $self = clone $this;
