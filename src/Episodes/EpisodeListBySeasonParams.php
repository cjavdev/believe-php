 ...
 *
 * @see Believe\Services\EpisodesService::listBySeason()
 *
 * @phpstan-type EpisodeListBySeasonParamsShape = array{
 *   limit?: int|null, skip?: int|null
 * }
 */
final class EpisodeListBySeasonParams implements BaseModel
{
    /** @use SdkModel<EpisodeListBySeasonParamsShape> */
    use SdkModel;
    use SdkParams;
