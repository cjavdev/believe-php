...
use Believe\Client\TicketSales\TicketSaleNewResponse\PurchaseMethod;
 ...
 *
 * @phpstan-type TicketSaleNewResponseShape = array{
 *   id: string,
 *   buyerName: string,
 *   currency: string,
 *   discount: string,
 ...
 * }
 */
final class TicketSaleNewResponse implements BaseModel
{
    /** @use SdkModel<TicketSaleNewResponseShape> */
    use SdkModel;
    ...
    /**
     * `new TicketSaleNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TicketSaleNewResponse::with(
     *   id: ...,
     *   buyerName: ...,
     *   currency: ...,
     *   discount: ...,
