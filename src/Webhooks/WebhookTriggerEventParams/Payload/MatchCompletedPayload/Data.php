...
use Believe\Webhooks\WebhookTriggerEventParams\Payload\MatchCompletedPayload\Data\MatchType;
use Believe\Webhooks\WebhookTriggerEventParams\Payload\MatchCompletedPayload\Data\Result;
 ...
 */
  ...
  * @param string $tedPostMatchQuote
  * @param string|null $lessonLearned
  * @param string|null $manOfTheMatch
  *
  * @return self
 */
